...
SAVE_DIR = "./experiment_a_again_with_heapmaps"
os.makedirs(SAVE_DIR, exist_ok=True)
...
with open(csv_path, 'w', newline='') as f:
    ...
    for epoch in range(EPOCHS):
        ...
        if (epoch + 1) % 5 == 0:
            ...
            heatmap_dir = os.path.join(epoch_viz_dir, "heatmaps")
            save_heatmap_visualizations(model, val_dataset, heatmap_dir, num_samples=5)
